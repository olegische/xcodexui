...
.desktop-layout {
  @apply grid bg-zinc-100 text-zinc-900 overflow-hidden;
  height: 100vh;
  height: 100dvh;
...
.desktop-sidebar {
  @apply bg-zinc-100 min-h-0 overflow-hidden;
}

.desktop-resize-handle {
  @apply relative w-px cursor-col-resize bg-zinc-300 hover:bg-zinc-400 transition;
}
